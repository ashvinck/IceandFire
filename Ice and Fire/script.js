    ...
    fetch("https://anapioficeandfire.com/api/books?page=1&pageSize=50")
        ...
        .then(function (data) {
            ...
            data.forEach((info, id) => {
                const {name, isbn, numberOfPages, authors, publisher, released, characters} = info;
                result +=
                    `<div class="col-lg-4">
                            <div class="col-sm-12">
                                <div class="card">
                        ...
                        let characterArray = [`${characters[0]}`,`${characters[1]}`,`${characters[2]}`, `${characters[3]}`,`${characters[4]}`]
                        let newArray = [];
